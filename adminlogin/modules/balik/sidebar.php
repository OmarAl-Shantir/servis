...
<li class="nav-item">
    ...
    <div id="collapse'.$m['name'].'" class="collapse" aria-labelledby="headingAccounts"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item" href="/adminlogin/modules/'.strtolower($m['path']).'/?t=E">ETA cz</a>
            <a class="collapse-item" href="/adminlogin/modules/'.strtolower($m['path']).'/?t=B">Blesková výmena</a>
        </div>
    </div>
</li>
';}
