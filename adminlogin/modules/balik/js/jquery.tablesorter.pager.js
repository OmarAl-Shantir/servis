/*!
	'<li  class="paginate_button page-item" id="goto-page-' + g[o] + '"><span class="page-link" value="' + g[o] + '">' + g[o] + "</span></li>";
	...
	$.extend({
		tablesorterPager: new function() {
			...
			updatePageDisplay = function(table, p, completed) {
              ...
              t += '<li  class="paginate_button page-item" id="goto-page-' + options[indx] + '"><span class="page-link" value="' + options[indx] + '">' + options[indx] + "</span></li>";
					...
					if ($out.length) {
						...
						$out.find('.ts-startRow, .ts-page').unbind('click' + namespace).bind('click' + namespace, function() {
			...
			enablePager = function(table, p, triggered) {
				...
				size = 10; //$el.find('option[selected]').val();
